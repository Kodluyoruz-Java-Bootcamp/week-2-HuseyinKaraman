...
/**
 * @Note: getClone methodu ile Realty'in aynı özelliklere sahip clonu oluşturulur.
 * @author hsykrmn
 *
 */
public class Realty implements Prototype{
	...
	public Prototype getClone() {
		Realty newRealty = new Realty(no,title, publishedDate, user,  status);
		newRealty.setProvince(province);
		return newRealty;
	}
